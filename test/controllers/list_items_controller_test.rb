...
class ListItemsControllerTest < ActionController::TestCase
  ...
  test "should create list_item" do
    assert_difference('ListItem.count') do
      post :create, list_item: { Duedate: @list_item.Duedate, Name: @list_item.Name, Owner_id: @list_item.Owner_id, Parent_id: @list_item.Parent_id }
    end
  ...
  test "should update list_item" do
    patch :update, id: @list_item, list_item: { Duedate: @list_item.Duedate, Name: @list_item.Name, Owner_id: @list_item.Owner_id, Parent_id: @list_item.Parent_id }
    assert_redirected_to list_item_path(assigns(:list_item))
  end
